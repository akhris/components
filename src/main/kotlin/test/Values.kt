...
object Values {
    object Resistances {
        ...
        val value2_1 = EntityValuable(entity = Parameters.Electronic.resistance, value = "150", factor = 1e3f)
    ...
    object Capacities {
        val value1_1 = EntityValuable(entity = Parameters.Electronic.capacitance, value = "100", factor = 1e-9f)
        ...
        val value2_1 = EntityValuable(entity = Parameters.Electronic.resistance, value = "1", factor = 1e-6f)
